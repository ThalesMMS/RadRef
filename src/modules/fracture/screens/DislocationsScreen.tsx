...
export function DislocationsScreen() {
  ...
  return (
    <Screen titleKey="fracture.tools.dislocations.title" subtitleKey="fracture.tools.dislocations.meta">
      <Banner titleKey="fracture.dislocation.scopeTitle" textKey="fracture.dislocation.scopeText" />
      <Section headerKey="fracture.dislocation.inputsTitle" footerKey="fracture.dislocation.inputsDescription">
        <ChoiceRow labelKey="fracture.dislocation.jointLabel" options={jointOptions} value={joint} onChange={setJoint} variant="list" />
